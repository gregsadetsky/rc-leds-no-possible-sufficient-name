...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--ipAddress", required=True, help="The IP address of the Pixelblaze"
    )
    parser.add_argument(
        "--r", required=True, help="The Red value (0..1) to be sent to the Pixelblaze"
    )
    parser.add_argument(
        "--g", required=True, help="The Green value (0..1) to be sent to the Pixelblaze"
    )
    parser.add_argument(
        "--b", required=True, help="The Blue value (0..1) to be sent to the Pixelblaze"
    )
    ...
    with Pixelblaze(args.ipAddress) as pb:
        patternBytecode = pb.compilePattern(
